...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/rbc.data', help='*.data file path')     #自己的数据集
    ...
    parser.add_argument('--weights', type=str, default='weights/yolov3-spp.weights', help='initial weights')      #预训练模型初始化权重
